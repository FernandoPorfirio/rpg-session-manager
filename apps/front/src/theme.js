...
const theme = createTheme({
  ...
  components: {
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          boxShadow: '0 2px 8px rgba(139, 69, 19, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
          border: '1px solid #654321',
          color: '#F5DEB3',
          transition: 'all 0.3s ease',
          '&:hover': {
            background: 'linear-gradient(135deg, #A0522D 0%, #8B4513 100%)',
            boxShadow: '0 4px 12px rgba(184, 134, 11, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
        ...
        outlined: {
          background: 'linear-gradient(135deg, rgba(245, 245, 220, 0.9) 0%, rgba(245, 245, 220, 0.7) 100%)',
    ...
    MuiPaper: {
      styleOverrides: {
        root: {
          ...
          boxShadow: '0 4px 20px rgba(47, 79, 79, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
        },
        elevation3: {
          boxShadow: '0 6px 25px rgba(47, 79, 79, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
        },
      },
    },
    MuiTextField: {
    ...
    MuiDialog: {
      styleOverrides: {
        paper: {
          background: 'linear-gradient(135deg, rgba(245, 245, 220, 0.98) 0%, rgba(245, 245, 220, 0.92) 100%)',
    ...
    MuiAlert: {
      styleOverrides: {
        ...
        standardError: {
          background: 'linear-gradient(135deg, rgba(139, 0, 0, 0.1) 0%, rgba(205, 92, 92, 0.1) 100%)',
          border: '1px solid #8B0000',
          color: '#8B0000',
        },
        standardSuccess: {
          background: 'linear-gradient(135deg, rgba(85, 107, 47, 0.1) 0%, rgba(107, 142, 35, 0.1) 100%)',
      ...
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            ...
            boxShadow: '0 8px 25px rgba(47, 79, 79, 0.2), 0 0 20px rgba(184, 134, 11, 0.1)',
          },
        },
      },
    },
